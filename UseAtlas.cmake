...
IF(USE_ATLAS)
    ...
    IF ( UNIX AND NOT APPLE )
        ...
        FIND_LIBRARY(GFORTRAN_LIB gfortran ${ATLAS_LIB_SEARCHPATH})

        #SET(LAPACK_LIBRARIES ${ATLAS_LIB} ${LAPACK_ATLAS_LIB} ${LAPACK_LIB} ${BLAS_LIB})
        SET(LAPACK_LIBRARIES ${ATLAS_LIB} ${LAPACK_ATLAS_LIB} ${LAPACK_LIB} ${BLAS_LIB} ${GFORTRAN_LIB})
