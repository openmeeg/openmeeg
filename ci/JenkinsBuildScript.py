...
def cmake_configuration(args):
    ...
    add_cmake_parameter(args.blimpl,'BLASLAPACK_IMPLEMENTATION',cmake_command_line)
...
parser.add_argument('--blaslapack-implementation',dest='omp',action='store_true',help='chose a Blas/Lapack implementation (Atlas/OpenBlas/MKL/Lapack)')
