...
if ((${CMAKE_PROJECT_NAME} STREQUAL "OpenMEEG") AND STANDALONE)
    foreach(alib openblas lapacke quadmath gcc_s pthread gfortran.4 gfortran gomp blas lapack)
        find_library(found${alib} NAMES ${alib} PATHS
            /usr/local/opt/gcc/lib/gcc/7
            ${OpenBLAS_LIB_SEARCH_PATHS}
            /usr/local/Cellar/
            PATH_SUFFIXES gcc/${CMAKE_CXX_COMPILER_VERSION} ${CMAKE_CXX_COMPILER_VERSION} gcc/x86_64-linux-gnu/${CMAKE_CXX_COMPILER_VERSION} gcc/4.9 gcc/7)
        if (found${alib})
