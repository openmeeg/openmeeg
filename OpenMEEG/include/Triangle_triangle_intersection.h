...
/*                                                                           */
/*                                                                           */
/*  This paper listed above, and other information are available             */
/*  from the Web page                                                        */
...
/*  Using this code:                                                         */
/*                                                                           */
/*  First, read the paper (from the Web page above).                         */
/*                                                                           */
/*                                                                           */
/*  Several geometric predicates are defined.  Their parameters are all      */
/*    points.  Each point is an array of two or three double precision       */
/*    floating point numbers. The geometric predicates, described in         */
/*    the papers, are                                                        */
/*                                                                           */
/*                                                                           */
...
/*                                                                           */
/*    int tri_tri_intersection_test_3d(p1,q1,r1,p2,q2,r2,coplanar,           */
/*                                     source,target)                        */
/*       a version that computes the segment of intersection when            */
...
namespace OpenMEEG {
    ...
    double triangle_area(const double p[3],const double q[3],const double r[3]) {
    ...
    bool ccw_tri_tri_intersection_2d(const double p1[2],const double q1[2],const double r1[2],
    ...
    bool tri_tri_overlap_test_2d(const double p1[2],const double q1[2],const double r1[2],
                                 const double p2[2],const double q2[2],const double r2[2]) {
    ...
    bool coplanar_tri_tri3d(const double p1[3],const double q1[3],const double r1[3],
                            const double p2[3],const double q2[3],const double r2[3],
                            const double normal_1[3],const double[3]) {
    ...
    bool tri_tri_overlap_test_3d(const double p1[3],const double q1[3],const double r1[3],
                                 const double p2[3],const double q2[3],const double r2[3])
    {
    ...
    bool tri_tri_intersection_test_3d(const double p1[3],const double q1[3],const double r1[3],
                                      const double p2[3],const double q2[3],const double r2[3],
                                      int* coplanar,
