...
extern "C" {
double FC_GLOBAL(dlange, DLANGE)(const char &, const int &, const int &,
                                 const double *, const int &, double *);

void FC_GLOBAL(dsptrf, DSPTRF)(const char &, const int &, double *, int *,
                               int &);
void FC_GLOBAL(dsptrs, DSPTRS)(const char &, const int &, const int &, double *,
                               int *, double *, const int &, int &);
void FC_GLOBAL(dsptri, DSPTRI)(const char &, const int &, double *, int *,
                               double *, int &);
void FC_GLOBAL(dpptrf, DPPTRF)(const char &, const int &, double *, int &);
void FC_GLOBAL(dpptri, DPPTRI)(const char &, const int &, double *, int &);

void FC_GLOBAL(dgesdd, DGESDD)(const char &, const int &, const int &, double *,
