...
macro(CHECK_CXX_FEATURE feature file message)
    if (NOT ${feature}_DONE)
        ...
        message(WARNING "${CHECK_CXX_FEATURE_LINK_LIBRARIES} ${libs}")
...
macro(CHECK_CXX_STANDARD_LIBRARY)
    ...
    CHECK_CXX_FEATURE(HAVE_SHARED_PTR_ARRAY_EXTENSION    shared_ptr_array_extension.cpp    "has C++17 extension of shared_ptr for arrays")
