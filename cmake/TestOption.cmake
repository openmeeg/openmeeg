...
if (BUILD_TESTING)
    ...
    if (WIN32)
        ...
        set(INSTALL_DIRS ${ZLIB_ROOT} ${HDF5_ROOT_DIR} ${matio_LIBRARY_DIR} ${lapack_DIR} ${VTK_LIBRARY_DIRS} ${CGAL_LIBRARY_DIRS} ${NIFTI_DIR})
        foreach (dir ${INSTALL_DIRS})
            set(LIBRARY_PATHS "${dir}/bin;${LIBRARY_PATHS}")
        endforeach()
