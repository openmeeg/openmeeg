...
if (BUILD_TESTING)
    ...
    message("=== ${LAPACK_DLL_DIR}} ===")
    if (WIN32)
        set(TestConfigFile "${CMAKE_BINARY_DIR}/TestConfig.cmake")
        get_property(HDF5_LIB TARGET hdf5 PROPERTY IMPORTED_LOCATION_RELEASE)
        message("HERE ${HDF5_LIB}")
        get_filename_component(HDF5_DIR ${HDF5_LIB} DIRECTORY)
        get_filename_component(HDF5_DIR ${HDF5_DIR} DIRECTORY)
        set(INSTALL_DIRS ${ZLIB_ROOT}/bin ${HDF5_ROOT_DIR}/bin ${HDF5_DIR}/bin ${matio_ROOT_DIR}/bin ${LAPACK_DLL_DIR} ${VTK_LIBRARY_DIRS} ${CGAL_LIBRARY_DIRS} ${NIFTI_DIR})
